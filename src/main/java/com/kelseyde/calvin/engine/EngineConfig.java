...
public class EngineConfig {
    ...
    public final Tunable seeQuietHistoryDivisor = new Tunable("SeeQuietHistoryDivisor", 32, 8, 32, 2);
    ...
    public final Tunable seeNoisyHistoryDivisor = new Tunable("SeeNoisyHistoryDivisor", 64, 32, 256, 16);
    ...
    public Set<Tunable> getTunables() {
        return Set.of(
                ...
                seeMaxDepth, seeQuietMargin, seeNoisyMargin, seeNoisyOffset, seeQuietHistoryDivisor, seeNoisyHistoryDivisor,
                timeFactor, incrementFactor, softTimeFactor, hardTimeFactor, softTimeScaleMin, softTimeScaleMax,
                uciOverhead, bmStabilityMinDepth, scoreStabilityMinDepth
        );
    }
