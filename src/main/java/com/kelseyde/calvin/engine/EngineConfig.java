...
public class EngineConfig {
    ...
    public final Tunable quietHistMaxScore      = new Tunable("QuietHistMaxScore", 16384, 1000, 20000, 100);
    ...
    public final Tunable captHistMaxScore       = new Tunable("CaptHistMaxScore", 16384, 1000, 20000, 100);
    ...
    public final Tunable contHistMaxScore       = new Tunable("ContHistMaxScore", 16384, 1000, 20000, 100);
