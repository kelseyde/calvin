...
public class EngineConfig {
    ...
    public final Tunable aspMargin            = new Tunable("AspMargin", 50, 0, 250, 25);
    public final Tunable aspFailMargin        = new Tunable("AspFailMargin", 149, 0, 300, 25);
    ...
    public final Tunable nmpMargin            = new Tunable("NmpMargin", 30, 0, 250, 25);
    public final Tunable nmpImpMargin         = new Tunable("NmpImpMargin", 85, 0, 250, 25);
    ...
    public final Tunable fpMargin             = new Tunable("FpMargin", 293, 0, 500, 25);
    public final Tunable fpScale              = new Tunable("FpScale", 47, 0, 100, 5);
    public final Tunable fpBlend              = new Tunable("FpBlend", 6, 1, 10, 2);
    public final Tunable qsFpMargin           = new Tunable("QsFpMargin", 71, 0, 250, 10);
    ...
    public final Tunable rfpMargin            = new Tunable("RfpMargin", 126, 0, 250, 25);
    public final Tunable rfpImpMargin         = new Tunable("RfpImpMargin", 41, 0, 250, 25);
    public final Tunable rfpBlend             = new Tunable("RfpBlend", 4, 1, 10, 2);
    public final Tunable lmrDepth             = new Tunable("LmrDepth", 2, 0, 8, 1);
    public final Tunable lmrBase              = new Tunable("LmrBase", 96, 50, 100, 5);
    public final Tunable lmrDivisor           = new Tunable("LmrDivisor", 310, 200, 400, 10);
    public final Tunable lmrCapBase           = new Tunable("LmrCapBase", 93, 50, 100, 5);
    ...
    public final Tunable dpMargin             = new Tunable("DpMargin", 105, 0, 250, 10);
    public final Tunable razorDepth           = new Tunable("RazorDepth", 5, 0, 8, 1);
    public final Tunable razorMargin          = new Tunable("RazorMargin", 504, 0, 600, 10);
    public final Tunable hpMaxDepth           = new Tunable("HpMaxDepth", 1, 0, 10, 1);
    public final Tunable hpMargin             = new Tunable("HpMargin", -2223, -4000, -100, 50);
    public final Tunable hpOffset             = new Tunable("HpOffset", -1016, -3000, 0, 50);
