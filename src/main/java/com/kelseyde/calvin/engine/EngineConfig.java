...
public class EngineConfig {
    ...
    public final Tunable quietHistBonusOffset   = new Tunable("QuietHistBonusOffset", 40, 0, 100, 20);
    ...
    public final Tunable quietHistMalusOffset   = new Tunable("QuietHistMalusOffset", 40, 0, 100, 20);
    ...
    public final Tunable captHistBonusOffset    = new Tunable("CaptHistBonusOffset", 40, 0, 100, 20);
    ...
    public final Tunable captHistMalusOffset    = new Tunable("CaptHistMalusOffset", 40, 0, 100, 20);
    ...
    public final Tunable contHistBonusOffset    = new Tunable("ContHistBonusOffset", 40, 0, 100, 20);
    ...
    public final Tunable contHistMalusOffset    = new Tunable("ContHistMalusOffset", 40, 0, 100, 20);
