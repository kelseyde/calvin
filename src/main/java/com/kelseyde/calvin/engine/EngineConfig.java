...
public class EngineConfig {
    ...
    public final Tunable aspMargin            = new Tunable("AspMargin", 49, 0, 250, 25);
    public final Tunable aspFailMargin        = new Tunable("AspFailMargin", 141, 0, 300, 25);
    ...
    public final Tunable nmpMargin            = new Tunable("NmpMargin", 25, 0, 250, 25);
    public final Tunable nmpImpMargin         = new Tunable("NmpImpMargin", 107, 0, 250, 25);
    ...
    public final Tunable fpScale              = new Tunable("FpScale", 53, 0, 100, 5);
    public final Tunable fpBlend              = new Tunable("FpBlend", 5, 1, 10, 2);
    public final Tunable qsFpMargin           = new Tunable("QsFpMargin", 93, 0, 250, 10);
    ...
    public final Tunable rfpMargin            = new Tunable("RfpMargin", 98, 0, 250, 25);
    public final Tunable rfpImpMargin         = new Tunable("RfpImpMargin", 39, 0, 250, 25);
    public final Tunable rfpBlend             = new Tunable("RfpBlend", 5, 1, 10, 2);
    public final Tunable lmrDepth             = new Tunable("LmrDepth", 2, 0, 8, 1);
    public final Tunable lmrBase              = new Tunable("LmrBase", 97, 50, 100, 5);
    public final Tunable lmrDivisor           = new Tunable("LmrDivisor", 310, 200, 400, 10);
    public final Tunable lmrCapBase           = new Tunable("LmrCapBase", 94, 50, 100, 5);
    ...
    public final Tunable dpMargin             = new Tunable("DpMargin", 104, 0, 250, 10);
    ...
    public final Tunable hpOffset             = new Tunable("HpOffset", -1020, -3000, 0, 50);
