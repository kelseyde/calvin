...
public class EngineConfig {
    ...
    public final Tunable aspMargin            = new Tunable("AspMargin", 23, 0, 250, 10);
    public final Tunable aspFailMargin        = new Tunable("AspFailMargin", 97, 0, 300, 10);
    ...
    public final Tunable nmpMargin            = new Tunable("NmpMargin", 10, 0, 250, 10);
    public final Tunable nmpImpMargin         = new Tunable("NmpImpMargin", 47, 0, 250, 10);
    ...
    public final Tunable fpMargin             = new Tunable("FpMargin", 265, 0, 500, 10);
    public final Tunable fpScale              = new Tunable("FpScale", 72, 0, 100, 5);
    public final Tunable qsFpMargin           = new Tunable("QsFpMargin", 84, 0, 250, 10);
    ...
    public final Tunable rfpMargin            = new Tunable("RfpMargin", 95, 0, 250, 10);
    public final Tunable rfpImpMargin         = new Tunable("RfpImpMargin", 49, 0, 250, 10);
    public final Tunable lmrDepth             = new Tunable("LmrDepth", 2, 0, 8, 1);
    public final Tunable lmrBase              = new Tunable("LmrBase", 86, 50, 100, 5);
    ...
    public final Tunable lmpMultiplier        = new Tunable("LmpMultiplier", 9, 1, 20, 1);
    public final Tunable iirDepth             = new Tunable("IirDepth", 5, 0, 8, 1);
    public final Tunable dpMargin             = new Tunable("DpMargin", 120, 0, 250, 10);
    public final Tunable razorDepth           = new Tunable("RazorDepth", 6, 0, 8, 1);
    public final Tunable razorMargin          = new Tunable("RazorMargin", 506, 0, 600, 10);
    public final Tunable hpMaxDepth           = new Tunable("HpMaxDepth", 4, 0, 10, 1);
    public final Tunable hpMargin             = new Tunable("HpMargin", -2265, -4000, -100, 50);
    public final Tunable hpOffset             = new Tunable("HpOffset", -1036, -3000, 0, 50);
