...
public class BlunderTest {
    ...
    public void testDontSacKnightForCenterPawn() {
        ...
        System.out.println(Move.toUCI(move));
        Assertions.assertFalse(move.matches(Move.fromUCI("f6e4")));
    ...
    public void testDontSacKnightForCenterPawn2() {
        ...
        Move move = engine.think(500).move();
        System.out.println(Move.toUCI(move));
        Assertions.assertFalse(move.matches(Move.fromUCI("f3d4")));
        Assertions.assertFalse(move.matches(Move.fromUCI("e2d4")));
    ...
    public void testDontMoveRookBeforeCastling() {
        ...
        Move move = engine.think(500).move();
        System.out.println(Move.toUCI(move));
        Assertions.assertFalse(move.matches(Move.fromUCI("h1g1")));
    ...
    public void testDontSacYourQueenForPawn() {
        ...
        Move move = engine.think(500).move();
        System.out.println(Move.toUCI(move));
        Assertions.assertFalse(move.matches(Move.fromUCI("d8d3")));
    ...
    public void testDontRepeatWhenCompletelyWinning() {
        ...
        moves.add(Move.fromUCI("h8b8"));
        moves.add(Move.fromUCI("e4c3"));
        moves.add(Move.fromUCI("e7c5"));
        moves.add(Move.fromUCI("c3e4"));
        moves.add(Move.fromUCI("c5e7"));
        moves.add(Move.fromUCI("e4c3"));
        moves.add(Move.fromUCI("e7c5"));
        ...
        Move move = engine.think(500).move();
        System.out.println(Move.toUCI(move));
        Assertions.assertFalse(move.matches(Move.fromUCI("c3e4")));
    ...
    public void testDontPushPawnShield() {
        ...
        Move move = engine.think(500).move();
        System.out.println(Move.toUCI(move));
        Assertions.assertFalse(move.matches(Move.fromUCI("g7g5")));
    }
    ...
    public void testDontSacQueenForKnight() {
        ...
        Move move = engine.think(500).move();
        System.out.println(Move.toUCI(move));
        Assertions.assertFalse(move.matches(Move.fromUCI("c4c7")));
    ...
    public void testIgnoreQueenKnightMatingAttack() {
        ...
        Move move = engine.think(500).move();
        System.out.println(Move.toUCI(move));
        Assertions.assertTrue(move.matches(Move.fromUCI("f1g1")));
    ...
    public void testDontBlunderRook() {
        ...
        Assertions.assertTrue(
                move.matches(Move.fromUCI("c5e4"))
            ||  move.matches(Move.fromUCI("e2e4"))
        );
    ...
    public void testDontBlunderRook2() {
        ...
        Assertions.assertFalse(
                move.matches(Move.fromUCI("b8b3"))
        );
    ...
    public void testDontBlunderQueen() {
        ...
        System.out.println(Move.toUCI(move));
        Assertions.assertFalse(
                move.matches(Move.fromUCI("a5c7"))
        );
    ...
    public void testDontBlunderQueenDiscoveredCheck() {
        ...
        System.out.println(Move.toUCI(move));
        Assertions.assertTrue(
                move.matches(Move.fromUCI("c2d3"))
        );
    ...
    public void testDontBlunderQueen2() {
        ...
        System.out.println(Move.toUCI(move));
        Assertions.assertFalse(
                move.matches(Move.fromUCI("d1d4")));
    ...
    public void testDontWalkIntoPin() {
        ...
        System.out.println(Move.toUCI(move));
        Assertions.assertFalse(
                move.matches(Move.fromUCI("g4e5")));
    ...
    public void testDontBlunderBishop() {
        ...
        System.out.println(Move.toUCI(move));
        Assertions.assertFalse(
                move.matches(Move.fromUCI("g4f3")));
    ...
    public void testDontSacBishopForTwoPawns() {
        ...
        System.out.println(Move.toUCI(move));
        Assertions.assertFalse(
                move.matches(Move.fromUCI("c6d5")));
    ...
    public void testDontBlunderRook3() {
        ...
        System.out.println(Move.toUCI(move));
        Assertions.assertFalse(
                move.matches(Move.fromUCI("b3b6"))
        );
    ...
    public void testDontMoveKingBeforeCastling() {
        ...
        System.out.println(Move.toUCI(move));
        Assertions.assertFalse(
                move.matches(Move.fromUCI("e8f8"))
        );
    ...
    public void testDontMoveKingBeforeCastling2() {
        ...
        System.out.println(Move.toUCI(move));
        Assertions.assertFalse(
                move.matches(Move.fromUCI("e8d8"))
        );
    ...
    public void testDontSacExchangeForSpeculativeCompensation() {
        ...
        System.out.println(Move.toUCI(move));
        Assertions.assertFalse(
                move.matches(Move.fromUCI("e8e5"))
        );
    ...
    public void testCastleOutOfDanger() {
        ...
        System.out.println(Move.toUCI(move));
        Assertions.assertFalse(
                move.matches(Move.fromUCI("a8d8"))
        );
    ...
    public void testDontSacExchangeForSpeculativeCompensation2() {
        ...
        System.out.println(Move.toUCI(move));
        Assertions.assertFalse(
                move.matches(Move.fromUCI("f8f3"))
        );
    ...
    public void testDontLetOpponentBuildBigCenter() {
        ...
        System.out.println(Move.toUCI(move));
        Assertions.assertFalse(
                move.matches(Move.fromUCI("d5c4"))
        );
    ...
    public void testDontLosePawnInDrawnEndgame() {
        ...
        System.out.println(Move.toUCI(move));
        Assertions.assertFalse(
                move.matches(Move.fromUCI("g5g4"))
        );
    ...
    public void testOneMoveToPreventMateThreat() {
        ...
        System.out.println(Move.toUCI(move));
        Assertions.assertTrue(
                move.matches(Move.fromUCI("g3d6"))
        );
    ...
    public void testAvoidForcedDraw() {
        ...
        System.out.println(Move.toUCI(move));
        Assertions.assertFalse(
                move.matches(Move.fromUCI("h2g1"))
        );
    ...
    public void testDontSacBishopOnF3() {
        ...
        System.out.println(Move.toUCI(move));
        Assertions.assertFalse(
                move.matches(Move.fromUCI("b7f3"))
        );
    ...
    public void testDontMoveBishopWhereItCanBeKicked() {
        ...
        System.out.println(Move.toUCI(move));
        Assertions.assertFalse(
                move.matches(Move.fromUCI("f8c5"))
        );
    ...
    public void testDontOpenHFileToKing() {
        ...
        System.out.println(Move.toUCI(move));
        Assertions.assertTrue(
                move.matches(Move.fromUCI("h6h5"))
        );
    ...
    public void testDefendAgainstHeavyPieceMatingAttack() {
        ...
        System.out.println(Move.toUCI(move));
        Assertions.assertTrue(
                move.matches(Move.fromUCI("f4f5"))
        );
    ...
    public void testDontSacBishopTacticWhenKingIsInDanger() {
        ...
        System.out.println(Move.toUCI(move));
        Assertions.assertFalse(
                move.matches(Move.fromUCI("e5h2"))
        );
    ...
    public void testDontLetOpponentBuildQueenBishopBattery() {
        ...
        System.out.println(Move.toUCI(move));
        Assertions.assertTrue(
                move.matches(Move.fromUCI("c7c8")) ||
                        move.matches(Move.fromUCI("a6a8"))
        );
    ...
    public void testDontBlockBishopAttackOnRookWithFreePawn() {
        ...
        System.out.println(Move.toUCI(move));
        Assertions.assertFalse(
                move.matches(Move.fromUCI("c7c6"))
        );
        Assertions.assertTrue(
                move.matches(Move.fromUCI("a8b8")) ||
                        move.matches(Move.fromUCI("a8a7"))
        );
    ...
    public void testDontHangKnightForTwoPawns() {
        ...
        System.out.println(Move.toUCI(move));
        Assertions.assertTrue(
                move.matches(Move.fromUCI("e4c5"))
        );
    ...
    public void testDontThrowDrawnOppositeBishopsEndgame() {
        ...
        System.out.println(Move.toUCI(move));
        Assertions.assertTrue(
                move.matches(Move.fromUCI("f6f7"))
        );
    ...
    public void testDontAllowDesperadoOnF7() {
        ...
        System.out.println(Move.toUCI(move));
        Assertions.assertTrue(
                move.matches(Move.fromUCI("d8e7"))
        );
    ...
    public void testDontAllowBishopSacOnH6() {
        ...
        System.out.println(Move.toUCI(move));
        Assertions.assertFalse(
                move.matches(Move.fromUCI("h7h6"))
        );
    ...
    public void testDontBlunderKnight() {
        ...
        System.out.println(Move.toUCI(move));
        Assertions.assertFalse(
                move.matches(Move.fromUCI("c6e5"))
        );
    ...
    public void testDontSacKnightForPawn() {
        ...
        System.out.println(Move.toUCI(move));
        Assertions.assertFalse(
                move.matches(Move.fromUCI("d4c6"))
        );
    ...
    public void testDontMissCrushingAttack() {
        ...
        System.out.println(Move.toUCI(move));
        Assertions.assertTrue(
                move.matches(Move.fromUCI("e2f2"))
        );
    ...
    public void testDontForceRepetitionWhenMating() {
        ...
        board.makeMove(Move.fromUCI("e8d8"));
        board.makeMove(Move.fromUCI("e6e5"));
        board.makeMove(Move.fromUCI("d8d7"));
        board.makeMove(Move.fromUCI("e5e6"));
        board.makeMove(Move.fromUCI("d7d8"));
        board.makeMove(Move.fromUCI("e6e5"));
        board.makeMove(Move.fromUCI("d8d7"));
        ...
        System.out.println(Move.toUCI(move));
        Assertions.assertFalse(
                move.matches(Move.fromUCI("e5e6"))
        );
